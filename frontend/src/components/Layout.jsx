...
const Layout = ({ children }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (isCommitteesOpen || isBoardsOpen || isDocumentsOpen || isDvcOpen) {
  ...
  }, [isCommitteesOpen, isBoardsOpen, isDocumentsOpen, isDvcOpen])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-asdvc-gray-50 via-white to-asdvc-gray-100 relative">
      ...
      <header className="bg-gradient-to-r from-asdvc-forest to-asdvc-forest-light shadow-lg border-b border-asdvc-forest-dark relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="md:hidden">
              <button className="text-white hover:text-asdvc-gold">
        ...
        {/* Mobile Navigation */}
        <div className="md:hidden bg-asdvc-forest-light">
